...
//     vidya: false,
//     seva: false,
//     login: false, // 🔥 Add login dropdown state
//   });
...
//                   className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-100 hover:bg-orange-100 dark:hover:bg-gray-700"
//                 >
//                   {t("pranPratishtha") || "Pran Pratishtha"}
//                 </Link>
//                 <Link
//                   to="/services/hawan"
//                   className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-100 hover:bg-orange-100 dark:hover:bg-gray-700"
...
//                   className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-100 hover:bg-orange-100 dark:hover:bg-gray-700"
//                 >
//                   {t("sacredMantras") || "Sacred Mantras"}
//                 </Link>
//                 <Link
//                   to="/vidya/meditation"
//                   className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-100 hover:bg-orange-100 dark:hover:bg-gray-700"
...
//                   className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-100 hover:bg-orange-100 dark:hover:bg-gray-700"
//                 >
//                   {t("charitablePrograms") || "Charitable Programs"}
//                 </Link>
//                 <Link
//                   to="/seva/community-service"
//                   className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-100 hover:bg-orange-100 dark:hover:bg-gray-700"
//                 >
//                   {t("communityService") || "Community Service"}
//                 </Link>
//                 <Link
//                   to="/seva/donate"
//                   className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-100 hover:bg-orange-100 dark:hover:bg-gray-700"
...
//               <Link
//                 to="/signup"
//                 className="btn-primary ml-4 dark:bg-primary-700 dark:text-white"
//               >
//                 {t("signUp") || "Sign Up"}
//               </Link>
...
//         onClick={() => setDropdowns(prev => ({ ...prev, login: false }))}
//       >
//         Login as User
//       </Link>
//       <Link
...
//       {/* Mobile menu remains unchanged — update it similarly if needed */}
//     </header>
//   )
// }
